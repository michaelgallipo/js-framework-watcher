...
export default {
  ...
  created: function() {
    ...
    axios.get("https://api.github.com/repos/vuejs/vue", {}, auth).then(response => {
    ...
    axios.get("https://api.github.com/repos/angular/angular.js", {}, auth).then(response => {
    ...
    axios.get("https://api.github.com/repos/emberjs/ember.js", {}, auth).then(response => {
    ...
    axios.get("https://api.github.com/repos/sveltejs/svelte", {}, auth).then(response => {
    ...
    axios.get("https://api.github.com/repos/facebook/react", {}, auth).then(response => {
